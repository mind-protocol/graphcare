...
- **Foundation:** `/home/mind-protocol/mindprotocol/docs/specs/v2/autonomy/architecture/foundation.md`
- **Event Contracts:** `/home/mind-protocol/mindprotocol/docs/specs/v2/autonomy/membrane-first/02_event_contracts.md`
- **Cross-Level Membrane:** `/home/mind-protocol/mindprotocol/docs/specs/v2/autonomy/architecture/cross_level_membrane.md`
