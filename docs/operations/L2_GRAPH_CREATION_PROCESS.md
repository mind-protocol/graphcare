...
> **NOTE (2025-11-08):** This document describes initial graph construction (Service 1 of 5 in GraphCare's care model). See `/docs/GRAPHCARE_ROLE_SPEC.md` for the complete kidney/ongoing care model.

**Author:** Mel "Bridgekeeper" - Chief Care Coordinator
**Date:** 2025-11-04
**Purpose:** Define mindset, guidelines, process, and automation boundaries for creating client L2 graphs (Service 1)
