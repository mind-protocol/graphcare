...
> **NOTE (2025-11-08):** This document describes the initial graph construction process, which is now **Service 1 of 5** in GraphCare's care model. See `/docs/GRAPHCARE_ROLE_SPEC.md` for the complete kidney/ongoing care model (construction, sync, monitoring, optimization, emergency response).

**Author:** Mel "Bridgekeeper" - Chief Care Coordinator
**Date:** 2025-11-04
**Purpose:** Step-by-step operational workflow for initial graph construction (Service 1)
